...
select
    ...
    tpep_dropoff_datetime::timestamp as dropff_ts,
    passenger_count::int as passengers_count,
    trip_distance::numeric(14,2) as trip_distance,
    pulocationid::int as pickup_location,
    dolocationid::int as dropff_location,
    ratecodeid::int as ratecode_id,
    payment_type::int as payment_type,
    fare_amount::numeric(14,2) as fare_amount,
    tip_amount::numeric(14,2) as tip_amount,
    tolls_amount::numeric(14,2) as tolls_amount,
    total_amount::numeric(14,2) as total_amount,
    service_type::text as service_type,
    source_month::text as source_month,
